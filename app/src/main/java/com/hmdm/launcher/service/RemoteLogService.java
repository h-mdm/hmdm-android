...
public class RemoteLogService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i(Const.LOG_TAG, "RemoteLogService called");
        scheduleUpload(this, FIRE_PERIOD_MINS);
        return START_STICKY;
    }

    protected static void scheduleUpload(Context context, int delayMins) {
        OneTimeWorkRequest.Builder builder = new OneTimeWorkRequest.Builder(UploadLogWorker.class);
    ...
    public static class UploadLogWorker extends Worker {

        private Context context;
        private SettingsHelper settingsHelper;

        public UploadLogWorker(
            ...
            try {
                ...
                while (true) {
                    ...
                    if (!upload(unsentItems)) {
                        ...
                        uploadScheduled = false;
                        RemoteLogService.scheduleUpload(context, FIRE_PERIOD_RETRY_MINS);
                ...
                e.printStackTrace();
                uploadScheduled = false;
                RemoteLogService.scheduleUpload(context, FIRE_PERIOD_MINS);
                return Result.failure();
            }
        }
